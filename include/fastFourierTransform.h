...
//
// Description:
//  Defines functions for computing fast fourier transform:
//    - fft -- computes complex FFT
//    - ifft -- computes inverse complex FFT
//    - rfft -- computes real FFT (convenience function for complex FFT with zero-valued imaginary components)
//
*/
#ifndef VOCAL_SYNTH_FAST_FOURIER_TRANSFORM_H
#define VOCAL_SYNTH_FAST_FOURIER_TRANSFORM_H


#include <stdlib.h>  // u_int16_t
#include "fftLookupTables.h"
...
//
// Description:
//  Computes the real FFT (using decimation in time) of the X array and places it in the Y arrays.
//  This is a convenience function for computing complex FFT with zero-valued imaginary components.
//
// Arguments:
//  - float X_Re[FFT_N] -- Real component of input buffer
//  - float Y_Re[FFT_N] -- Real component of output buffer
